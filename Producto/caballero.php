...
// Consulta para obtener los productos de la tabla producto de la categoría 'Caballero'
$query = "SELECT * FROM producto WHERE categorias = 'Caballero'"; // Filtra según la categoría 'Caballero'
